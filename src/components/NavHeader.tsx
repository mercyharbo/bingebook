...
export default function NavHeader() {
  ...
  const { searchQuery, setSearchQuery, showResults, setShowResults } =
    useSearchStore()
  ...
  return (
    <header
      className={`sticky top-0 z-40 flex h-20 shrink-0 items-center justify-between gap-4 px-6 lg:px-8 transition-all duration-300 ${isScrolled ? 'bg-black/60 backdrop-blur-xl border-b border-white/5 shadow-2xl' : 'bg-transparent'}`}
    >
