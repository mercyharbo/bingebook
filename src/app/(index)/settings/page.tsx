          ...
          <section className="space-y-6">
            ...
            <Card className="glass-dark border-white/5 overflow-hidden rounded-3xl">
              <CardContent className="p-8 space-y-8">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-base font-medium">Glassmorphism Effects</Label>
                    <p className="text-sm text-muted-foreground">
          ...
          <section className="space-y-6">
            ...
            <Card className="glass-dark border-white/5 overflow-hidden rounded-3xl">
              <CardContent className="p-8 space-y-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-base font-medium">Upcoming Releases</Label>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-base font-medium">Market Reminders</Label>
                    <p className="text-sm text-muted-foreground">
            ...
            <Card className="glass-dark border-white/5 overflow-hidden rounded-3xl">
              <CardContent className="p-8 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="destructive" className="rounded-xl shadow-lg shadow-destructive/20">Delete Account</Button>
                </div>
              </CardContent>
            </Card>
          </section>
