...
export default function SignupPage() {
  ...
  return (
    <div className='min-h-screen flex'>
      ...
      <div className='hidden lg:flex flex-1 relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600'>
        ...
        {/* Floating Elements */}
        <div className='absolute top-16 left-16 w-20 h-20 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-2xl'>
          🎭
        </div>
        <div className='absolute bottom-20 left-20 w-24 h-24 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-3xl'>
          🎪
        </div>
        <div className='absolute top-1/3 left-8 w-16 h-16 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-xl'>
          🎨
        </div>
      </div>
        ...
        <div className='w-full max-w-md space-y-8'>
          ...
          <div className='text-center space-y-2'>
            ...
            <p className='text-muted-foreground'>
              Join the community and start tracking your favorite movies
            </p>
          </div>
